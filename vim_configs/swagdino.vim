...
let s:orange          = { "gui": "#D75F5F", "cterm": "202" }

let s:darker_blue     = { "gui": "#005F87", "cterm": "18"  }
let s:dark_blue       = { "gui": "#008EC4", "cterm": "4"   }
let s:blue            = { "gui": "#20BBFC", "cterm": "12"  }
let s:light_blue      = { "gui": "#b6d6fd", "cterm": "27"  }
...
let s:dark_purple     = { "gui": "#523C79", "cterm": "53"  }
let s:light_purple    = { "gui": "#6855DE", "cterm": "93"  }

let s:yellow          = { "gui": "#F3E430", "cterm": "11"  }
let s:light_yellow    = { "gui": "#FFFF5F", "cterm": "227" }
let s:dark_yellow     = { "gui": "#A89C14", "cterm": "3"   }

let s:yellow_green    = { "gui": "#afd700", "cterm": "148" }
...
call s:h("PreProc",       {"fg": s:yellow, "gui": "underline", "cterm": "underline"})
...
call s:h("ColorColumn",   {"bg": s:bg_not_subtle})

" remainder of syntax highlighting
call s:h("MatchParen",    {"bg": s:bg_subtle, "fg": s:yellow})
