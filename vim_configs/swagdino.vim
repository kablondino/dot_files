" Vim color file - swagdino
" Generated by http://bytefluent.com/vivify 2017-04-05
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi IncSearch guifg=#C4BE89 guibg=#000000 guisp=#000000 gui=NONE ctermfg=0 ctermbg=11 cterm=NONE
...
hi NonText guifg=#870000 guibg=NONE guisp=#3B3A32 gui=NONE ctermfg=88 ctermbg=NONE cterm=bold
...
hi SpecialChar guifg=#5F0000 guibg=NONE guisp=NONE gui=bold ctermfg=197 ctermbg=NONE cterm=bold
...
hi LineNr guifg=#D75F00 guibg=#1c1c1c guisp=#3B3A32 gui=NONE ctermfg=167 ctermbg=234 cterm=NONE
hi CursorLineNr guifg=#000000 guibg=#afff00 guisp=NONE gui=bold,italic ctermfg=16 ctermbg=154 cterm=bold,italic
...
hi CursorLine guifg=NONE guibg=#262626 guisp=#3E3D32 gui=NONE ctermfg=NONE ctermbg=235 cterm=NONE
...
hi CursorColumn guifg=NONE guibg=#262626 guisp=#3E3D32 gui=NONE ctermfg=NONE ctermbg=235 cterm=NONE
...
hi Cursor guifg=#000000 guibg=#afff00 guisp=#F8F8F0 gui=NONE ctermfg=NONE ctermbg=154 cterm=NONE
...
hi SpecialKey guifg=#870000 guibg=NONE guisp=NONE gui=italic ctermfg=88 ctermbg=NONE cterm=bold
...
hi pythonimport guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi stringdelimiter guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubyregexp guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi string guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi constant guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi normal guifg=#ffcbff guibg=#151115 guisp=#151115 gui=NONE ctermfg=225 ctermbg=233 cterm=NONE
hi rubyinstancevariable guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi identifier guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi comment guifg=#ffcbff guibg=NONE guisp=NONE gui=italic ctermfg=225 ctermbg=NONE cterm=NONE
hi rubyregexpdelimiter guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubyregexpspecial guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubypredefinedidentifier guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi function guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi directory guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubycontrol guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi rubyidentifier guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi condtional guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi pythonbuiltin guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#ffcbff guibg=NONE guisp=NONE gui=NONE ctermfg=225 ctermbg=NONE cterm=NONE
